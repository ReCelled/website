...
export default function DashboardPage() {
	...
	return (
		<>
			<title>Recelled - Dashboard</title>
								...
								<div className="flex items-start gap-4">
									<div className="flex-1">
										...
										<p className="text-[#B9BBBE]">
											Link your Patreon account to benefit from the Recelled
										...
										>
											<a href="https://recelled.dev/api/v1/oauth/patreon">
												Link accounts
											</a>
										</Button>
									</div>
						...
						<Card className="bg-[#2B2D31] border-none text-white">
							<CardHeader>
								...
								<CardDescription className="text-[#B9BBBE]">
									You can choose to permanently delete your Recelled account. Be
							...
							<CardContent>
								...
								>
									...
									<AlertDescription>
										We will drop any data we have about you, and you'll no
										longer be able to benefit from features requiring a Recelled
										account (such as enhanced Spotify plugin, settings sync, and
										more).
									</AlertDescription>
								</Alert>
								<Button
