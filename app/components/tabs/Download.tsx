...
export default function Download() {
  return (
    <div className="bg-[#2f3136] rounded-lg p-6">
      <h2 className="text-2xl font-bold mb-4 text-white">Download Recelled</h2>
      <p className="mb-4 text-[#b9bbbe]">Get the latest version of Recelled for your operating system:</p>
